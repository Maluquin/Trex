...
function setup(){
  ...
  chao = createSprite(300,185,600,10);
  chao.addImage(chaoImagem);
  chaoInvisivel = createSprite(300,192,600,5);
...
function criarNuvem(){
  if (frameCount % 80 ===0){
   nuvem = createSprite(600,30,40,10);
   nuvem.velocityX = -5;
   nuvem.addImage(nuvemImagem)
   nuvem.scale = 0.9
   nuvem.y = Math.round (random(55,100));
...
function criarCactos(){
  if (frameCount % 70 === 0){
   obstaculo = createSprite(600,170,40,60);
   obstaculo.scale = 0.6;
